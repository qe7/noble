...
import sh.squeami.noble.uis.click.impl.component.BooleanComponent;
import sh.squeami.noble.uis.click.impl.component.EnumComponent;
import sh.squeami.noble.uis.click.impl.component.numberComponents.DoubleComponent;
import sh.squeami.noble.uis.click.impl.component.numberComponents.FloatComponent;
import sh.squeami.noble.uis.click.impl.component.numberComponents.IntComponent;
...
public class ClickButton {
    ...
    public ClickButton(Feature feature) {
        ...
        Noble.INSTANCE.getSettingManager().getSettingsByFeature(feature).forEach(setting -> {
    ...
    public void drawScreen(int mouseX, int mouseY, float posX, float posY) {
        ...
        if (Noble.INSTANCE.getSettingManager().getSettingsByFeature(feature).isEmpty()) return;
