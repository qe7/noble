    ...
    public void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            ...
            if (this.ridingEntity == null) {
                if (flag2 && flag3) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(motionEvent.getPositionX(), motionEvent.getPositionY(), motionEvent.getPositionZ(), motionEvent.getRotationYaw(), motionEvent.getRotationPitch(), motionEvent.isOnGround()));
                } else if (flag2) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(motionEvent.getPositionX(), motionEvent.getPositionY(), motionEvent.getPositionZ(), motionEvent.isOnGround()));
                } else if (flag3) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C05PacketPlayerLook(motionEvent.getRotationYaw(), motionEvent.getRotationPitch(), motionEvent.isOnGround()));
                } else {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer(motionEvent.isOnGround()));
                }
            } else {
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.motionX, -999.0D, this.motionZ, motionEvent.getRotationYaw(), motionEvent.getRotationPitch(), motionEvent.isOnGround()));
                flag2 = false;
            }
            ...
            if (flag2) {
                this.lastReportedPosX = motionEvent.getPositionX();
                this.lastReportedPosY = motionEvent.getPositionY();
                this.lastReportedPosZ = motionEvent.getPositionZ();
